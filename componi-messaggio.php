...
<html>
<head>
 <title>AdminLTE 2 | Componi messaggio</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="posta-elettronica.php" class="btn btn-primary btn-block margin-bottom">Posta in arrivo</a>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Componi Nuovo Messaggio</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" placeholder="A:">
              </div>
              <div class="form-group">
                <input class="form-control" placeholder="Oggetto:">
              </div>
              <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 300px">
                      <h1><u>Titolo del messaggio</u></h1>
                      <h4>Sottotitolo</h4>
            ...
            <div class="box-footer">
              <div class="pull-right">
                <button type="button" class="btn btn-default"><i class="fa fa-pencil"></i> Bozza</button>
                <button type="submit" class="btn btn-primary"><i class="fa fa-envelope-o"></i> Invia</button>
              </div>
              <button type="reset" class="btn btn-default"><i class="fa fa-times"></i> Elimina</button>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
