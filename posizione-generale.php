...
<html>
<head>
 <title>AdminLTE 2 | Posizione generale</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><u>Posizione generale</u></li>
      </ol>
    </section>

  <!-- Main content -->
    <section class="content"><?php require 'pages/fragments/modulo-generico.php';?>   
    </section>
    <!-- /.content -->
