...
<html>
<head>
 <title>AdminLTE 2 | Richiesta anticipazione IFR/TFR</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Richiesta anticipazione IFR/TFR
      </h1>
      <ol class="breadcrumb">
    ...
    <!-- Main content -->
    <section class="content"><?php require 'pages/fragments/modulo-ric-tfr.php';?>   
    </section>
    <!-- /.content -->
