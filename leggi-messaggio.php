...
<html>
<head>
<title>AdminLTE 2 | Leggi messaggio</title>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3>Report settembre 2017</h3>
                <h5>Da: Andrea@gmail.com
                  <span class="mailbox-read-time pull-right">15 Novembre 2017 11:03 PM</span></h5>
              </div>
              <!-- /.mailbox-read-info -->
              <div class="mailbox-controls with-border text-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-container="body" title="Cancella">
                    <i class="fa fa-trash-o"></i></button>
                  <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-container="body" title="Rispondi">
                    <i class="fa fa-reply"></i></button>
                  <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-container="body" title="Inoltra">
              ...
              <ul class="mailbox-attachments clearfix">
                <li>
                  ...
                  <div class="mailbox-attachment-info">
                    <a href="#" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i> Settembre2017-report.pdf</a>
                ...
                <li>
                  ...
                  <div class="mailbox-attachment-info">
                    <a href="#" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i> Descrizione.docx</a>
                        <span class="mailbox-attachment-size">
                          1,245 KB
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                        </span>
            ...
            <div class="box-footer">
              <div class="pull-right">
                ...
                <button type="button" class="btn btn-default"><i class="fa fa-share"></i> Inoltra</button>
              </div>
              <button type="button" class="btn btn-default"><i class="fa fa-trash-o"></i> Cancella</button>
              <button type="button" class="btn btn-default"><i class="fa fa-print"></i> Stampa</button>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
